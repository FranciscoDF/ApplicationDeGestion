...
namespace POOProject {
	...
	/// <summary>
	/// Description résumée de CommandeAjouterForm
	/// </summary>
	public ref class CommandeAjouterForm : public System::Windows::Forms::Form
	{
	public:
		CommandeAjouterForm(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonAjouter->Location = System::Drawing::Point(411, 349);
			...
			this->buttonAjouter->Click += gcnew System::EventHandler(this, &CommandeAjouterForm::buttonAjouter_Click);
			// 
			// buttonAnnuler
			// 
			...
			this->buttonAnnuler->Click += gcnew System::EventHandler(this, &CommandeAjouterForm::buttonAnnuler_Click);
			// 
			// label1
			// 
			...
			this->Name = L"CommandeAjouterForm";
			this->Text = L"CommandeAjouterForm";
...
#pragma endregion
	...
	private: System::Void buttonAjouter_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (ref == "" || numClient == "" || dateLivr == "" || dateEmi == "" || datePaie == "" || moyPaie == "" || refArt == "" || quantiteArt == "") {
			...
			Commande monCommande(ref, numClient, dateLivr, dateEmi, datePaie, moyPaie, refArt, quantiteArt);
			monCommande.Ajouter();
